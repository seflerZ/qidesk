...
public class Constants {
    ...
    public static final String defaultPackageName = "com.qihua.defaultbVNC";
    ...
    public static final int SOCKET_CONN_TIMEOUT = 8 * 1000; // 8 sec
    ...
    public static final int DEFAULT_NVSTREAM_PORT = 47989;
    public static final int DEFAULT_RDP_COLOR_MODE = 32;
    // URI Parameters
    ...
    public final static int RDP_GEOM_SELECT_CUSTOM = 4;
    ...
    public static final String verticalExtraKeysPref = "verticalExtraKeysPref";
    public static final String horizontalExtraKeysPref = "horizontalExtraKeysPref";
    ...
    public static final int SHORT_VIBRATION = 40;
