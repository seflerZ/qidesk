...
public class MyGestureDectector
{
    ...
    private int mLongpressTimeout = 450;
     ...
     */
    public MyGestureDectector(Context context, OnGestureListener listener)
    {
     ...
     * @see android.os.Handler#Handler()
     */
    public MyGestureDectector(Context context, OnGestureListener listener, Handler handler)
    {
    ...
    private void init(Context context, boolean ignoreMultitouch)
    {
        ...
        mIgnoreNextMove = new AtomicBoolean(false);
...
//                    mHandler.sendEmptyMessageDelayed(TAP, 10);
//                }
                if (mInLongPress)
                {
                    mHandler.removeMessages(TAP);
                ...
                else if (mAlwaysInTapRegion && !mIsDoubleTapping)
                {
