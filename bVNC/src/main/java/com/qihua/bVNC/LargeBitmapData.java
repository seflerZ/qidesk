...
class LargeBitmapData extends AbstractBitmapData {
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractBitmapData#copyRect(android.graphics.Rect, android.graphics.Rect, android.graphics.Paint)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractBitmapData#offset(int, int)
     */
    @Override
    ...
    protected synchronized void scrollChanged(int newx, int newy) {
        ...
        int visibleWidth = vncCanvas.getVisibleDesktopWidth();
        int visibleHeight = vncCanvas.getVisibleDesktopHeight();
        if (newx - xoffset < 0) {
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractBitmapData#updateBitmap(int, int, int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractBitmapData#updateBitmap(Bitmap, int, int, int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractBitmapData#validDraw(int, int, int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractBitmapData#prepareFullUpdateRequest(boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.qihua.bVNC.AbstractBitmapData#frameBufferSizeChanged(RfbProto)
     */
    @Override
