...
public class AutoXCustomizeDialog extends AlertDialog {
    private static final Intent docIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://qihua.blogspot.ca/2012/10/looking-for-nx-client-for-android-or.html"));
