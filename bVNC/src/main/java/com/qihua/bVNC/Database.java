...
import com.qihua.bVNC.input.AbstractMetaKeyBean;
...
public class Database extends SQLiteOpenHelper {
    ...
    static final int DBV_2_2_0 = 515;
    static final int DBV_2_2_1 = 516;
    static final int DBV_2_2_2 = 518;
    static final int DBV_2_2_3 = 520;
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion == DBV_2_1_9) {
            Log.i(TAG, "Doing upgrade from 513 to 515");
            db.execSQL("ALTER TABLE " + AbstractConnectionBean.GEN_TABLE_NAME + " ADD COLUMN "
                    + AbstractConnectionBean.GEN_FIELD_PRIORITY + " INTEGER DEFAULT 0");
            oldVersion = DBV_2_2_0;
        }

        if (oldVersion == DBV_2_2_0) {
            Log.i(TAG, "Doing upgrade from 515 to 516");
            db.execSQL("ALTER TABLE " + AbstractConnectionBean.GEN_TABLE_NAME + " ADD COLUMN "
                    + AbstractConnectionBean.GEN_FIELD_ENABLE_GESTURE + " INTEGER DEFAULT 1");
            oldVersion = DBV_2_2_1;
        }

        if (oldVersion == DBV_2_2_1) {
            Log.i(TAG, "Doing upgrade from 516 to 518");
            db.execSQL("ALTER TABLE " + AbstractConnectionBean.GEN_TABLE_NAME + " ADD COLUMN "
                    + AbstractConnectionBean.GEN_FIELD_ZOOM_LEVEL + " INTEGER DEFAULT 100");
            oldVersion = DBV_2_2_2;
        }

        if (oldVersion == DBV_2_2_2) {
            Log.i(TAG, "Doing upgrade from 518 to 520");
            db.execSQL("ALTER TABLE " + AbstractConnectionBean.GEN_TABLE_NAME + " ADD COLUMN "
                    + AbstractConnectionBean.GEN_FIELD_GESTURE_CONFIG + " TEXT DEFAULT ''");
